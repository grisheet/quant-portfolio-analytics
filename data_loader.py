...
_TICKER_STYLE = {
    ...
    "JPM": "value", "JNJ": "value", "XOM": "value", "PG": "value",
    "TLT": "bond", "AGG": "bond", "GLD": "gold",
}
...
def generate_synthetic_prices(tickers: list[str], start: str, end: str,
    ...
    """
    Correlated GBM price paths. Deterministic (seeded) so demo outputs are
    reproducible. Clearly synthetic — never present these as real market results.
    """
